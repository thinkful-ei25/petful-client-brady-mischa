...
export default function Pet (props) {
    return (
      <section id={props.petToAdopt.pet.name + '-' + props.petToAdopt.pet.age}>
        <header>
          <h3 className="pet-name">Hi! I'm {props.petToAdopt.pet.name}</h3>          
        </header>
          ...
          <dl>
            ...
            <dd className="details">I'm a {props.petToAdopt.pet.age} Year Old, {props.petToAdopt.pet.sex}, {props.petToAdopt.pet.breed}</dd>
